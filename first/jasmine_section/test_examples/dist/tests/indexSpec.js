...
describe("test async function", function () {
    // using async await
    it("test async await ", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, index_1.asyncFun)()];
                case 1:
                    result = _a.sent();
    ...
    it("test with promise ", function () {
        return (0, index_1.asyncFun)().then(function (result) { return expect(result).toEqual('value'); });
    });
    // end of describe
});
